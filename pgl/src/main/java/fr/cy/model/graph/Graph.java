...
public class Graph {
    ...
    /**
     * Update the stress induced by each element and cache it. This method should be called at each tick
     */
    private void updateStressInducedByElements() {
        //update stress generated by each element and cache it, then update total stress induced including neighbors
